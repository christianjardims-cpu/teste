...
with st.sidebar:
    ...
    st.markdown("""
        <div class='corporate-signature-sidebar'>
            <p class='corp-title-sidebar'>CMPC</p>
            <p class='corp-author-sidebar'>Design & Development<br><b>Christian Jardim</b></p>
        </div>
    """, unsafe_allow_html=True)

# -----------------------------------------------------------------------------
# 6. HEADER DESIGN CONTEMPORÂNEO (MODIFICADO: EMOJI DE GRÁFICO NA REQUISICAO)
# -----------------------------------------------------------------------------
col_tit1, col_tit2 = st.columns([1.9, 1.1])
with col_tit1:
    st.markdown("<h1 style='font-weight: 600; font-size: 2.2rem; margin-bottom: 4px; font-family: \"SF Pro Display\",sans-serif;'>📊 Painel de Acompanhamento</h1>", unsafe_allow_html=True)
    st.markdown("<p style='color: #8b949e; margin: 0; font-size: 1rem;'>Monitoramento de Performance e Confiabilidade Global de Ativos</p>", unsafe_allow_html=True)
with col_tit2:
    st.markdown(f"""
...
# -----------------------------------------------------------------------------
# 8. SISTEMA ESTRUTURAL DE ABAS (MODIFICADO: TODOS OS EMOJIS CONFORME PEDIDO)
# -----------------------------------------------------------------------------
