...
if "versao_layout" not in st.session_state or st.session_state.versao_layout != "16.0_github_dark_performance":
    st.session_state.clear()  
    st.session_state.versao_layout = "16.0_github_dark_performance"
...
<style>
    ...
    /* Inputs Modernos com Interações Avançadas */
    ...
    /* Abas de Navegação Estilo Sub-nav GitHub */
...
# -----------------------------------------------------------------------------
# 2. SISTEMA DE BANCO DE DADOS (SQLITE OTIMIZADO COM ÍNDICES)
# -----------------------------------------------------------------------------
def inicializar_banco():
    with sqlite3.connect(DB_NOME) as conn:
        ...
        """)
        # Índice de performance para buscas rápidas multicritério
...
# -----------------------------------------------------------------------------
# 5. SIDEBAR: FLUID DESIGN (CLIMA SEMANAL REFINADO E ANIMADO)
# -----------------------------------------------------------------------------
with st.sidebar:
    ...
    for index, info in enumerate(dados_clima):
        ...
        # Adiciona a classe extra de destaque e indicador vertical se for o dia atual
...
# -----------------------------------------------------------------------------
# 7. FILTROS E RENDERIZAÇÃO FLUIDA COM STREAMLIT FRAGMENTS (ALTA PERFORMANCE)
# -----------------------------------------------------------------------------
...
# Envelopamento em Fragmento para evitar renderizações desnecessárias da tela completa
@st.fragment
