...
if "versao_layout" not in st.session_state or st.session_state.versao_layout != "19.1_github_gemini_area_advance":
    st.session_state.clear()  
    st.session_state.versao_layout = "19.1_github_gemini_area_advance"
...
# -----------------------------------------------------------------------------
# 6. HEADER DESIGN CONTEMPORÂNEO (REAJUSTADO PARA "SEMANA")
# -----------------------------------------------------------------------------
...
if st.session_state.db_data is not None and not st.session_state.db_data.empty:
    ...
    with aba_geral:
        ...
        with col_g2:
            # AJUSTADO E CORRIGIDO: Baseado estritamente em Avanço por ÁREA (com cores únicas por barra)
            ...
            if not df_geral_unicas.empty:
                ...
                for idx, area_item in enumerate(lista_areas_disponiveis):
                    ...
                    # Associa uma cor da paleta moderna para cada barra individual da área
