...
if "versao_layout" not in st.session_state or st.session_state.versao_layout != "15.0_github_dark_premium":
    st.session_state.clear()  
    st.session_state.versao_layout = "15.0_github_dark_premium"
...
<style>
    ...
    /* CARDS OPERACIONAIS - Efeito Hover Avançado */
    .os-card { 
        background: #161b22;
        border: 1px solid #30363d;
        border-radius: 6px; 
